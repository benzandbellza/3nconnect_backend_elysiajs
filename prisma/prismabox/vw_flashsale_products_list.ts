...
export const vw_flashsale_products_listPlain = t.Object(
  {
...
export const vw_flashsale_products_listRelations = t.Object(
  {},
  { additionalProperties: false },
);

export const vw_flashsale_products_listPlainInputCreate = t.Object(
  {
...
export const vw_flashsale_products_listPlainInputUpdate = t.Object(
  {
    promotion_type: t.Optional(__nullable__(t.String())),
    promotion_name: t.Optional(__nullable__(t.String())),
    company_name: t.Optional(__nullable__(t.String())),
...
export const vw_flashsale_products_listRelationsInputCreate = t.Object(
  {},
  { additionalProperties: false },
);

export const vw_flashsale_products_listRelationsInputUpdate = t.Partial(
  t.Object({}, { additionalProperties: false }),
);

export const vw_flashsale_products_listWhere = t.Partial(
  t.Recursive(
    (Self) =>
      t.Object(
        {
    ...
    { $id: "vw_flashsale_products_list" },
  ),
);

export const vw_flashsale_products_listWhereUnique = t.Recursive(
  (Self) =>
    t.Intersect(
      [
...
export const vw_flashsale_products_listSelect = t.Partial(
  t.Object(
    {
...
export const vw_flashsale_products_listInclude = t.Partial(
  t.Object({ _count: t.Boolean() }, { additionalProperties: false }),
);

export const vw_flashsale_products_listOrderBy = t.Partial(
  t.Object(
    {
...
export const vw_flashsale_products_list = t.Composite(
  [vw_flashsale_products_listPlain, vw_flashsale_products_listRelations],
  { additionalProperties: false },
);

export const vw_flashsale_products_listInputCreate = t.Composite(
  [
    vw_flashsale_products_listPlainInputCreate,
    vw_flashsale_products_listRelationsInputCreate,
  ],
  { additionalProperties: false },
);

export const vw_flashsale_products_listInputUpdate = t.Composite(
  [
    vw_flashsale_products_listPlainInputUpdate,
    vw_flashsale_products_listRelationsInputUpdate,
  ],
  { additionalProperties: false },
);
