...
export const lableaderstockPlain = t.Object(
  {
    id: t.Integer(),
...
export const lableaderstockRelations = t.Object(
  {},
  {
    additionalProperties: false,
    description: `This model contains row level security and requires additional setup for migrations. Visit https://pris.ly/d/row-level-security for more info.`,
...
export const lableaderstockPlainInputCreate = t.Object(
  {
...
export const lableaderstockPlainInputUpdate = t.Object(
  {
    MATUnit: t.Optional(__nullable__(t.String())),
    PO_: t.Optional(__nullable__(t.String())),
    PO_Date: t.Optional(__nullable__(t.String())),
...
export const lableaderstockRelationsInputCreate = t.Object(
  {},
  {
    additionalProperties: false,
    description: `This model contains row level security and requires additional setup for migrations. Visit https://pris.ly/d/row-level-security for more info.`,
...
export const lableaderstockRelationsInputUpdate = t.Partial(
  t.Object(
    {},
    {
      additionalProperties: false,
...
export const lableaderstockWhere = t.Partial(
  t.Recursive(
    (Self) =>
      t.Object(
        {
...
export const lableaderstockWhereUnique = t.Recursive(
  (Self) =>
    t.Intersect(
      [
        t.Partial(
...
export const lableaderstockSelect = t.Partial(
  t.Object(
    {
      id: t.Boolean(),
      MATUnit: t.Boolean(),
...
export const lableaderstockInclude = t.Partial(
  t.Object(
    { _count: t.Boolean() },
    {
      additionalProperties: false,
...
export const lableaderstockOrderBy = t.Partial(
  t.Object(
    {
...
export const lableaderstock = t.Composite(
  [lableaderstockPlain, lableaderstockRelations],
  { additionalProperties: false },
);

export const lableaderstockInputCreate = t.Composite(
  [lableaderstockPlainInputCreate, lableaderstockRelationsInputCreate],
  { additionalProperties: false },
);

export const lableaderstockInputUpdate = t.Composite(
  [lableaderstockPlainInputUpdate, lableaderstockRelationsInputUpdate],
  { additionalProperties: false },
);
