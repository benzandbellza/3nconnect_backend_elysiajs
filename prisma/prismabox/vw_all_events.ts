...
export const vw_all_eventsPlain = t.Object(
  {
    ...
    tier_register: __nullable__(t.String()),
    tier_preregister: __nullable__(t.String()),
...
export const vw_all_eventsPlainInputCreate = t.Object(
  {
    ...
    tier_register: t.Optional(__nullable__(t.String())),
    tier_preregister: t.Optional(__nullable__(t.String())),
