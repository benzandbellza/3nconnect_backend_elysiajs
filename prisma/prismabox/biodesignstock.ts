...
export const biodesignstockPlain = t.Object(
  {
    ID: t.Integer(),
...
export const biodesignstockRelations = t.Object(
  {},
  {
    additionalProperties: false,
    description: `This model contains row level security and requires additional setup for migrations. Visit https://pris.ly/d/row-level-security for more info.`,
...
export const biodesignstockPlainInputCreate = t.Object(
  {
...
export const biodesignstockPlainInputUpdate = t.Object(
  {
    MATUnit: t.Optional(__nullable__(t.String())),
    PO_: t.Optional(__nullable__(t.String())),
    PO_Date: t.Optional(__nullable__(t.String())),
...
export const biodesignstockRelationsInputCreate = t.Object(
  {},
  {
    additionalProperties: false,
    description: `This model contains row level security and requires additional setup for migrations. Visit https://pris.ly/d/row-level-security for more info.`,
...
export const biodesignstockRelationsInputUpdate = t.Partial(
  t.Object(
    {},
    {
      additionalProperties: false,
...
export const biodesignstockWhere = t.Partial(
  t.Recursive(
    (Self) =>
      t.Object(
        {
...
export const biodesignstockWhereUnique = t.Recursive(
  (Self) =>
    t.Intersect(
      [
        t.Partial(
...
export const biodesignstockSelect = t.Partial(
  t.Object(
    {
      ID: t.Boolean(),
      MATUnit: t.Boolean(),
...
export const biodesignstockInclude = t.Partial(
  t.Object(
    { _count: t.Boolean() },
    {
      additionalProperties: false,
...
export const biodesignstockOrderBy = t.Partial(
  t.Object(
    {
...
export const biodesignstock = t.Composite(
  [biodesignstockPlain, biodesignstockRelations],
  { additionalProperties: false },
);

export const biodesignstockInputCreate = t.Composite(
  [biodesignstockPlainInputCreate, biodesignstockRelationsInputCreate],
  { additionalProperties: false },
);

export const biodesignstockInputUpdate = t.Composite(
  [biodesignstockPlainInputUpdate, biodesignstockRelationsInputUpdate],
  { additionalProperties: false },
);
