...
export const product_targetPlain = t.Object(
  {
    id: t.Integer(),
    created_at: t.Date(),
...
export const product_targetRelations = t.Object(
  {
...
export const product_targetPlainInputCreate = t.Object(
  {
...
export const product_targetPlainInputUpdate = t.Object(
  {
    created_at: t.Optional(t.Date()),
    target_date: t.Optional(__nullable__(t.Date())),
    matcat: t.Optional(__nullable__(t.String())),
...
export const product_targetRelationsInputCreate = t.Object(
  {
...
export const product_targetRelationsInputUpdate = t.Partial(
  t.Object(
    {
      companies: t.Partial(
        t.Object(
...
export const product_targetWhere = t.Partial(
  t.Recursive(
    (Self) =>
      t.Object(
        {
...
export const product_targetWhereUnique = t.Recursive(
  (Self) =>
    t.Intersect(
      [
        t.Partial(
...
export const product_targetSelect = t.Partial(
  t.Object(
    {
      id: t.Boolean(),
...
export const product_targetInclude = t.Partial(
  t.Object(
...
export const product_targetOrderBy = t.Partial(
  t.Object(
    {
...
export const product_target = t.Composite(
  [product_targetPlain, product_targetRelations],
  { additionalProperties: false },
);

export const product_targetInputCreate = t.Composite(
  [product_targetPlainInputCreate, product_targetRelationsInputCreate],
  { additionalProperties: false },
);

export const product_targetInputUpdate = t.Composite(
  [product_targetPlainInputUpdate, product_targetRelationsInputUpdate],
  { additionalProperties: false },
);
