...
export const public_productsPlain = t.Object(
  {
    id: t.Integer(),
...
export const public_productsRelations = t.Object(
  {
...
export const public_productsPlainInputCreate = t.Object(
  {
    ...
    category_hierarchy: t.Optional(__nullable__(t.Any())),
...
export const public_productsPlainInputUpdate = t.Object(
  {
    product_name: t.Optional(__nullable__(t.String())),
    product_description: t.Optional(__nullable__(t.String())),
    created_at: t.Optional(__nullable__(t.Date())),
...
export const public_productsRelationsInputCreate = t.Object(
  {
...
export const public_productsRelationsInputUpdate = t.Partial(
  t.Object(
    {
...
export const public_productsWhere = t.Partial(
  t.Recursive(
    (Self) =>
      t.Object(
        {
...
export const public_productsWhereUnique = t.Recursive(
  (Self) =>
    t.Intersect(
      [
        t.Partial(
...
export const public_productsSelect = t.Partial(
  t.Object(
    {
      id: t.Boolean(),
...
export const public_productsInclude = t.Partial(
  t.Object(
    {
      product_options: t.Boolean(),
      product_payment_method: t.Boolean(),
...
export const public_productsOrderBy = t.Partial(
  t.Object(
    {
...
export const public_products = t.Composite(
  [public_productsPlain, public_productsRelations],
  { additionalProperties: false },
);

export const public_productsInputCreate = t.Composite(
  [public_productsPlainInputCreate, public_productsRelationsInputCreate],
  { additionalProperties: false },
);

export const public_productsInputUpdate = t.Composite(
  [public_productsPlainInputUpdate, public_productsRelationsInputUpdate],
  { additionalProperties: false },
);
