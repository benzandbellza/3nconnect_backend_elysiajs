...
export const customer_saved_cardsPlain = t.Object(
  {
    id: t.String(),
...
export const customer_saved_cardsRelations = t.Object(
  {
...
export const customer_saved_cardsPlainInputCreate = t.Object(
  {
    card_type: t.String(),
    masked_number: t.String(),
...
export const customer_saved_cardsPlainInputUpdate = t.Object(
  {
    card_type: t.Optional(t.String()),
    masked_number: t.Optional(t.String()),
    is_default: t.Optional(t.Boolean()),
    created_at: t.Optional(t.Date()),
  },
  {
...
export const customer_saved_cardsRelationsInputCreate = t.Object(
  {
    customeruser: t.Object(
      {
        connect: t.Object(
...
export const customer_saved_cardsRelationsInputUpdate = t.Partial(
  t.Object(
    {
      customeruser: t.Object(
        {
...
export const customer_saved_cardsWhere = t.Partial(
  t.Recursive(
    (Self) =>
      t.Object(
        {
    ...
    { $id: "customer_saved_cards" },
  ),
);

export const customer_saved_cardsWhereUnique = t.Recursive(
  (Self) =>
    t.Intersect(
      [
        t.Partial(
...
export const customer_saved_cardsSelect = t.Partial(
  t.Object(
    {
      id: t.Boolean(),
      customer_id: t.Boolean(),
      card_type: t.Boolean(),
      masked_number: t.Boolean(),
      is_default: t.Boolean(),
...
export const customer_saved_cardsInclude = t.Partial(
  t.Object(
...
export const customer_saved_cardsOrderBy = t.Partial(
  t.Object(
    {
      ...
      card_type: t.Union([t.Literal("asc"), t.Literal("desc")], {
        additionalProperties: false,
      }),
      masked_number: t.Union([t.Literal("asc"), t.Literal("desc")], {
        additionalProperties: false,
      }),
...
export const customer_saved_cards = t.Composite(
  [customer_saved_cardsPlain, customer_saved_cardsRelations],
  { additionalProperties: false },
);

export const customer_saved_cardsInputCreate = t.Composite(
  [
    customer_saved_cardsPlainInputCreate,
    customer_saved_cardsRelationsInputCreate,
  ],
  { additionalProperties: false },
);

export const customer_saved_cardsInputUpdate = t.Composite(
  [
    customer_saved_cardsPlainInputUpdate,
    customer_saved_cardsRelationsInputUpdate,
  ],
  { additionalProperties: false },
);
