WITH union_planetone_stock AS (
  SELECT
    ...
    (g."QTY BLN(1)") :: integer AS qty_balance,
    (g."QTY Ready(2)") :: integer AS qty_ready,
    (g."QTY PN Out(3)") :: integer AS qty_pn_out,
    (g."QTY 1-3") :: integer AS qty_total,
    g."Unit" AS unit,
    g."Expired" AS expired,
    (g."Avail. Life") :: integer AS available_life,
    ...
    (g."QTY 1+2") :: integer AS qty_in_p_ready,
    (g."QTY 1+2-3") :: integer AS qty_in_p_ready_m_pnout,
  ...
  SELECT
    ...
    (l."QTY BLN(1)") :: integer AS qty_balance,
    (l."QTY Ready(2)") :: integer AS qty_ready,
    (l."QTY PN Out(3)") :: integer AS qty_pn_out,
    (l."QTY 1-3") :: integer AS qty_total,
    l."Unit" AS unit,
    l."Expired" AS expired,
    (l."Avail. Life") :: integer AS available_life,
    ...
    (l."QTY 1+2") :: integer AS qty_in_p_ready,
    (l."QTY 1+2-3") :: integer AS qty_in_p_ready_m_pnout,
    (l."Age") :: integer AS age,
  ...
  SELECT
    ...
    (b."QTY BLN(1)") :: integer AS qty_balance,
    (b."QTY Ready(2)") :: integer AS qty_ready,
    (b."QTY PN Out(3)") :: integer AS qty_pn_out,
    (b."QTY 1-3") :: integer AS qty_total,
    b."Unit" AS unit,
    b."Expired" AS expired,
    (b."Avail. Life") :: integer AS available_life,
    ...
    (b."QTY 1+2") :: integer AS qty_in_p_ready,
    (b."QTY 1+2-3") :: integer AS qty_in_p_ready_m_pnout,
    (b."Age") :: integer AS age,
